 ...
 *
 * @Override public void onClick(View v) { DateTimePickerDialog
 *           dateTimePicKDialog=new
 *           DateTimePickerDialog(SinvestigateActivity.this,initDateTime);
...
public class DateTimePickerDialog implements OnDateChangedListener,
    ...
    public AlertDialog dateTimePicKDialog(final EditText inputDate) {
        LinearLayout dateTimeLayout = (LinearLayout) activity
                .getLayoutInflater().inflate(R.layout.dialog_datetime_picker, null);
